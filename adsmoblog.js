...
var css = "<style>iframe{position:fixed;top:0px;left:0px;</style>"
function c() {
if (sdk==7) { document.write(css+https+"com.sangkhute.app"+googleads+"com.sangkhute.app"+net+"3582752291807258"+mads+"1416482000"+qma)}
else document.write(css+https+app+googleads+app+net+admob.slice(11, 27)+mads+admob.slice(28, 38)+qma)
}